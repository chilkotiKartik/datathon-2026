...
export const SidebarNav: React.FC = () => {
  ...
  useEffect(() => {
    const onResize = () => { if (!userSet.current) setCollapsed(window.innerWidth < 1024); };
  ...
  return (
    <aside
      className={`bg-navy-900 border-r border-navy-600 transition-all duration-300 flex flex-col z-30 ${
    ...
    >
      ...
      <div className="p-3 border-t border-navy-600/80">
        <button
